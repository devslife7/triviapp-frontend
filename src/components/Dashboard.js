...
function Dashboard(props) {
  ...
  const displayFriendList = () => {
    return friendList.map((friend, idx) => <p key={idx}> {friend.name} </p>)
  }
      ...
      >
          ...
          <Grid item xs={12}>
            <Paper elevation={6} style={{ textAlign: "center", padding: "30px", width: "350px" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-around", marginTop: "40px" }}>
                ...
                <Button onClick={handelLogOut} variant='outlined' color='primary'>
                  Log out
                </Button>
              </div>
            </Paper>
        ...
        <Grid item xs={2} style={{ marginBotton: "300px" }}>
          <Paper elevation={6} style={{ height: "550px", textAlign: "center", padding: "5px" }}>
            ...
            <Paper style={{ height: "450px", overflow: "auto" }}>{displayFriendList()}</Paper>
            <Button
        ...
        <Dialog disableBackdropClick disableEscapeKeyDown open={open} onClose={handleClose}>
          ...
          <DialogContent>
            <form className={classes.container} style={{ width: "250px" }}>
              ...
              />
              <TextField margin='normal' fullWidth id='img' label='Image Url' name='img' autoComplete='img' />
            </form>
          </DialogContent>
          <DialogActions>
