...
const Friends = props => {
  ...
  const colorsArray = ["#e33371", "#81c784", "#e57373", "#4791db", "#ffb74d", "#64b5f6"]
    ...
    <>
      <Container maxWidth='lg'>
        <Grid container justify='center' alignItems='center' spacing={10} className={classes.gridStyle}>
              ...
              <Grid container spacing={2}>
                <Grid item xs={12} md={6} style={{ maxWidth: "100%", flexBasis: "100%" }}>
                  <Typography
                    ...
                    style={{ textAlign: "center", margin: "12px 0px", color: "#4791db", fontSize: "29px" }}
                  >
                    Friend List
                  </Typography>
                  <Paper>
                    <List style={{ height: "518px", overflow: "auto" }}>{generateFriends()}</List>
                  </Paper>
                  <Button
          ...
          <IconButton
            style={{ backgroundColor: colorCycle, color: "white" }}
            onClick={() => props.history.push("/dashboard")}
          >
            ...
            <Paper elevation={5} style={{ height: "650px", textAlign: "center", padding: "5px" }}>
              <Grid container spacing={2}>
                <Grid item xs={12} md={6} style={{ maxWidth: "100%", flexBasis: "100%" }}>
                  ...
                  <Paper>
                    <List style={{ height: "532px", overflow: "auto" }}>{generateUsers(userList)}</List>
                  </Paper>
                </Grid>
              </Grid>
            </Paper>
